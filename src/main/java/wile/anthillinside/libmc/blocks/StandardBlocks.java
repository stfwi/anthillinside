...
public class StandardBlocks
{
  ...
  public static class Directed extends BaseBlock implements IStandardBlock
  {
    ...
    public Directed(long config, AbstractBlock.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
    {
  ...
  public static class Horizontal extends BaseBlock implements IStandardBlock
  {
    ...
    public Horizontal(long config, AbstractBlock.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
    {
  ...
  public static class DirectedWaterLoggable extends Directed implements IWaterLoggable, IStandardBlock
  {
    ...
    public DirectedWaterLoggable(long config, AbstractBlock.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
  ...
  public static class HorizontalWaterLoggable extends Horizontal implements IWaterLoggable, IStandardBlock
  {
    ...
    public HorizontalWaterLoggable(long config, AbstractBlock.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
